...
public class IndividualCustomersType {
    ...
    protected List<IndividualCustomerType> individualCustomer;

    /**
     * Gets the value of the individualCustomer property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the individualCustomer property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIndividualCustomer().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<IndividualCustomerType> getIndividualCustomer() {
        if (individualCustomer == null) {
            individualCustomer = new ArrayList<IndividualCustomerType>();
        }
