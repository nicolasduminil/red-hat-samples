...
public class Customer
{
  ...
  {
    this("NO_INTERNAL_NAME",
      Collections.singletonList(new Address(customer.getStreet(), customer.getCity(), customer.getState(), customer.getZip(), customer.getCountry())),
      Collections.singletonList(new Contact(customer.getFirstName(), customer.getLastName(), customer.getPhoneNumber(), customer.getEmailAddress())));
  }
